    ...
    <main>
        <section id="main">
            <div class="title">
                <h1> Aurora </h1> <hr>
                <p class="description"> 
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eu orci mattis lacus blandit fermentum. Vivamus quis rhoncus elit. Morbi vel lectus a lorem sagittis tempus in quis est. 
                Morbi a consectetur massa, nec dignissim lectus. Cras quis sodales ligula. In semper, urna eget eleifend pulvinar, odio eros finibus arcu, vel maximus libero libero vitae lorem.
                </p>
            </div>
        </section>
        <section id="map">
